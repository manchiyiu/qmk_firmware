...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		MO(3),				KC_LALT,	KC_LGUI,	KC_SPC,		MO(1),		KC_RALT,		KC_LEFT,	KC_DOWN,	KC_RGHT
	),
	...
	[3] = LAYOUT(
		KC_TRNS, 			STR_1, 		STR_2, 		STR_3, 		STR_4, 		STR_5, 			STR_6, 		STR_7, 		STR_8, 		STR_9, 		KC_TRNS, 			KC_TRNS, 	KC_TRNS, 		KC_TRNS,
